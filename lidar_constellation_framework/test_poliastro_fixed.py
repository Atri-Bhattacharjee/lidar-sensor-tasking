#!/usr/bin/env python3
"""
Test script to check if the fixed poliastro API works correctly.
"""
...
try:
    ...
    print("Testing fixed API with proper units...")
    ...
    # Create orbit with proper units (fixed API)
    ...
    print(f"✅ Orbit created successfully with fixed API!")
